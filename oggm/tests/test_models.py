...
class TestInitPresentDayFlowline:
    ...
    def test_init_present_time_glacier_obs_thick(
        ...
        fl_consensus = gdir.read_npz('model_flowlines',
        ...
        model_ref = FluxBasedModel(gdir.read_npz('model_flowlines'),
                                   mb_model=mb)
        ...
        fl_inv = gdir.read_npz('inversion_flowlines')[0]
        ...
        tasks.init_present_time_glacier(gdir, output_filesuffix='_consensus_rect',
                                        use_binned_thickness_data=vn)
        fl_consensus_rect = gdir.read_npz('model_flowlines',
...
class TestMassBalanceModels:
    ...
    def test_sfc_type_mb_model(self, hef_gdir):
        ...
        inv_fl = gdir.read_npz('inversion_flowlines')[-1]
        h = inv_fl.surface_h
    ...
    def test_sfc_type_save_load(self, hef_gdir):
        ...
        gdir = hef_gdir
        init_present_time_glacier(gdir)
        h = gdir.read_npz('inversion_flowlines')[-1].surface_h
        ...
        custom_fl = gdir.read_npz('inversion_flowlines')[-1]
    ...
    def test_sfc_type_mb_model_calib_dynamics(self):
        ...
        mb_mod_new.get_specific_mb(
            fls=gdir.read_npz('inversion_flowlines'), year=2019)
    ...
    def test_sfc_type_mass_conservation(self, hef_gdir):
        ...
        fl = copy.deepcopy(gdir.read_npz('model_flowlines')[-1])
        fl.thick = fl.thick * 0.
        fls = [fl]
...
class TestTrapezoidBoundary():
    ...
    def _put_on_boundary(self, gdir, fac):
        ...
        invs = gdir.read_npz('inversion_output')
        cls = gdir.read_npz('inversion_flowlines')
        cl, inv = cls[-1], invs[-1]
        ...
        gdir.write_npz(invs, 'inversion_output')
        return i
    ...
    def test_section_at_boundary(self, hef_gdir):
        ...
        fl = gdir.read_npz('model_flowlines')[-1]
...
class TestIO():
    ...
    def test_hef(self, class_case_dir, hef_gdir):
        ...
        fls = hef_gdir.read_npz('model_flowlines')
        model = FluxBasedModel(fls)
...
class TestIdealisedInversion():
    def simple_plot(self, model, gdir):  # pragma: no cover
        ocls = gdir.read_npz('inversion_output')
        ithick = ocls[-1]['thick']
    ...
    def test_inversion_rectangular(self, inversion_gdir):
        ...
        for fl in model.fls:
            ...
            fls.append(flo)
        inversion_gdir.write_npz(copy.deepcopy(fls), 'inversion_flowlines')
        ...
        inv_out = inversion_gdir.read_npz('inversion_input')
        ...
        inv_out = inversion_gdir.read_npz('inversion_output')
    ...
    def test_inversion_parabolic(self, inversion_gdir):
        ...
        inv = inversion_gdir.read_npz('inversion_output')[-1]
    ...
    def test_prepare_for_inversion_shape_flags(self, inversion_gdir):
        ...
        inversion.prepare_for_inversion(inversion_gdir)
        cl = inversion_gdir.read_npz('inversion_input')[0]
    ...
    def test_inversion_non_equilibrium(self, inversion_gdir):
        ...
        ocls = inversion_gdir.read_npz('inversion_output')
        ithick = ocls[0]['thick']
...
class TestHEF:
    ...
    def test_commitment(self, hef_gdir, inversion_params):
        ...
        glacier = hef_gdir.read_npz('model_flowlines')
...
class TestDynamicSpinup:
    ...
    def test_run_dynamic_spinup(self, hef_gdir, minimise_for):
        ...
        fls_zero_ice = hef_gdir.read_npz('model_flowlines')
    ...
    def test_run_dynamic_melt_f_calibration_with_dynamic_spinup(self,
        ...
        if do_inversion:
            ...
            assert np.all([np.all(getattr(fl_prev, 'surface_h') ==
                           ...
                           zip(fls, gdir.read_npz('model_flowlines'))])
...
class TestMergedHEF:
    ...
    def test_merged_simulation(self):
        ...
        assert 'RGI50-11.00719_d01' in [fl.rgi_id for fl in
                                        merge1.read_npz('model_flowlines')]
        ...
        # test flowlines
        fls = gdir_merged.read_npz('model_flowlines')
...
class TestSemiImplicitModel:
    ...
    def test_equilibrium(self, hef_elev_gdir, inversion_params):
        ...
        fls = hef_elev_gdir.read_npz('model_flowlines')
